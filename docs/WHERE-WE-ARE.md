...
- **Phase 1** — Catalog & selection: material type → manufacturers → products (tiles) → colors. Backend APIs + frontend screens. ✅  
...
- **Phase 3** — AI visualization flow:
  ...
  - Result screen with polling; shows “Generating…” then the image or an error; optional save / retry actions in app. ✅  
...
- [Compliance & copy](./COMPLIANCE-AND-COPY.md) — previews vs claims, disclaimers  
