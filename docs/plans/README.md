# RoofVision — Phase plans

Plans for each product phase. Use these for implementation checklists and reference.

| Plan | Description |
|------|-------------|
| [**phase1-plan.md**](./phase1-plan.md) | Phase 1 — Catalog & selection flow |
